...
//executar quando a tela for carregada.
    componentDidMount() {
        this.getMeteors()
    }
// fazer a solicitação para obter dados dos meteoros (igual tela ISSLocation)
    getMeteors = () => {
        axios
    ...
    render() {
       ...
       //verificar se há alguma chave em nosso estado de meteoros ou não
        if (Object.keys(this.state.meteors).length === 0) {
            ...
            //criar um meteoro_arr
        } else {
            let meteor_arr = Object.keys(this.state.meteors).map(meteor_date => {
                return this.state.meteors[meteor_date]
            })

            //calcular a pontuação de ameaça
            // concatenar todas as matrizes dentro do nosso meteor_arr
            ...
            //média somando os diâmetros mínimo e máximo e os dividindo por 2.
            ...
            return (
                <View style={styles.container}>
                    ...
                    {/* usar FlatList  para pegar uma matriz
de dados e processa todos os dados de maneira semelhante. */}
                    <FlatList
